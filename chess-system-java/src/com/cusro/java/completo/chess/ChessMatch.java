...
import com.cusro.java.completo.chess.pieces.*;
...
public class ChessMatch {
    ...
    private ChessPiece newPiece(String type, Color color) {
        return type.equals("B") ? new Bishop(board, color) :
                type.equals("N") ? new Knight(board, color) :
                        type.equals("R") ? new Rook(board, color) :
                                type.equals("Q") ? new Queen(board, color) : null;
    }
